...
class __TwigTemplate_a5f1a38d96a88859c6b8dd80b627cf74b787acfb44fe0dbb71ed556bb6cbee3b extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        // line 14
        $context["showCaptions"] = (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["design"] ?? null), "captions", [], "any", false, false, false, 14), "show_captions", [], "any", false, false, false, 14) && (0 !== twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["design"] ?? null), "captions", [], "any", false, false, false, 14), "show_captions", [], "any", false, false, false, 14), "never")));
        // line 15
        echo "
%%SELECTOR%% {
  --width: ";
  ...
  --columns: ";
        // line 20
        echo (((1 === twig_compare(($context["columns"] ?? null), 0))) ? (($context["columns"] ?? null)) : (""));
        echo ";
  --column-gap: ";
        // line 21
...
%%SELECTOR%% .ee-gallery-item {
  ...
  ";
        // line 39
        if ((0 === twig_compare(($context["breakpoint"] ?? null), twig_get_attribute($this->env, $this->source, ($context["layout"] ?? null), "vertical_at", [], "any", false, false, false, 39)))) {
            // line 40
  ...
  ";
        // line 43
        if (((0 === twig_compare(($context["type"] ?? null), "grid")) && (0 === twig_compare(($context["ratio"] ?? null), "custom")))) {
            // line 44
...
%%SELECTOR%% .ee-gallery-item-caption {
  ...
  ";
        // line 76
        if ((0 === twig_compare(($context["breakpoint"] ?? null), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["design"] ?? null), "captions", [], "any", false, false, false, 76), "hide_below", [], "any", false, false, false, 76)))) {
            // line 77
