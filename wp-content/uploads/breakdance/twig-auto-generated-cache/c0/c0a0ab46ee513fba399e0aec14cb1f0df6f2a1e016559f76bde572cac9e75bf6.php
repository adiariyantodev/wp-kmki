...
class __TwigTemplate_a9c41141317891c37c9ad0a0ebe27896eee4e000c7b63496506d0088c664f9e3 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 8
        if (((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["design"] ?? null), "button", [], "any", false, false, false, 8), "style", [], "any", false, false, false, 8), "custom")) && (0 === twig_compare(($context["breakpoint"] ?? null), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["design"] ?? null), "button", [], "any", false, false, false, 8), "custom", [], "any", false, false, false, 8), "size", [], "any", false, false, false, 8), "full_width_at", [], "any", false, false, false, 8))))) {
            // line 9
            echo "%%SELECTOR%% {
  width: 100%;
}
