...
/* 8ed8d65f266dcbecb4a63a26f16c96ef7bd678ed */
class __TwigTemplate_626f43ecf9ed53e1ef418f3fbe9ac2ad390ac09f2eaeec99d4b9d046b95b7732 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "
          ";
        // line 2
        $macros["macros"] = $this->macros["macros"] = $this->loadTemplate("macros.twig", "8ed8d65f266dcbecb4a63a26f16c96ef7bd678ed", 2)->unwrap();
        // line 3
        echo "
          ";
        // line 4
...
<form id=\"";
        ...
        echo "\" ";
        if ((0 <= twig_compare(($context["stepCount"] ?? null), 1))) {
...
<footer class=\"breakdance-form-field breakdance-form-footer\">
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["step"]) {
            ...
            echo twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 114);
            echo "\">
            ";
            // line 115
            echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(((twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", true, true, false, 115) &&  !(null === twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", false, false, false, 115)))) ? (twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", false, false, false, 115)) : ("Previous Step")), false, "breakdance-form-button breakdance-form-button__previous-step hidden", ($context["previousStepButtonDesign"] ?? null), "secondary", false, false, "step.next_button_text"], 115, $context, $this->getSourceContext());
            echo "
            ";
            // line 116
            echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(((twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", true, true, false, 116) &&  !(null === twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", false, false, false, 116)))) ? (twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", false, false, false, 116)) : ("Next Step")), false, "breakdance-form-button breakdance-form-button__next-step hidden", ($context["nextStepButtonDesign"] ?? null), "primary", false, false, "step.next_button_text"], 116, $context, $this->getSourceContext());
            echo "
        </div>
    ";
            ++$context['loop']['index0'];
        ...
        // line 119
        echo "    ";
        echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(($context["submitButtonText"]) ?? ("Submit")), false, "breakdance-form-button breakdance-form-button__submit", ($context["submitButtonDesign"] ?? null), "primary", ($context["submitButtonId"] ?? null), true, "content.form.submit_text"], 119, $context, $this->getSourceContext());
        echo "
  ...
  ";
    ...
    {
        return "8ed8d65f266dcbecb4a63a26f16c96ef7bd678ed";
    }
    ...
    {
        return array (  284 => 124,  275 => 119,  258 => 116,  254 => 115,  249 => 114,  232 => 113,  226 => 110,  149 => 35,  144 => 32,  128 => 29,  122 => 27,  120 => 26,  117 => 25,  111 => 23,  105 => 21,  103 => 20,  97 => 18,  80 => 17,  76 => 15,  74 => 14,  70 => 13,  56 => 12,  53 => 11,  51 => 9,  50 => 8,  49 => 6,  47 => 5,  45 => 4,  42 => 3,  40 => 2,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "8ed8d65f266dcbecb4a63a26f16c96ef7bd678ed", "");
    }
}
