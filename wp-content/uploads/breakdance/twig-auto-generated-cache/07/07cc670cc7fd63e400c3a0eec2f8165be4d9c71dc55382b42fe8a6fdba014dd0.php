...
class __TwigTemplate_8127f9f2d19914c296e21556aded4647b768715d120f5ea697a3da0ccafeeade extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 13
        if ((0 === twig_compare(($context["breakpoint"] ?? null), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["design"] ?? null), "layout", [], "any", false, false, false, 13), "stack_vertically_at", [], "any", false, false, false, 13)))) {
            // line 14
            echo "%%SELECTOR%% {
