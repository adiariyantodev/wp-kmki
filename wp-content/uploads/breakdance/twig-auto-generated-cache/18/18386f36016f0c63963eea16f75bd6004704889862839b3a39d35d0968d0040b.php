...
class __TwigTemplate_beb5522dda04b4eadbbf743d6e2c123d169a35ad3babb15436e800f802b705e3 extends Template
{
    private $source;
    private $macros = [];
...
";
  ...
  ";
        // line 8
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["design"] ?? null), "size", [], "any", false, false, false, 8), "height", [], "any", false, false, false, 8), "full"))) {
            // line 9
            echo "    height: 100%;
  ";
        } elseif ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,         // line 10
...
";
        // line 24
        if ((0 === twig_compare(($context["breakpoint"] ?? null), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["design"] ?? null), "layout", [], "any", false, false, false, 24), "slug_cant_start_with_number_50_width", [], "any", false, false, false, 24)))) {
            // line 25
...
";
        // line 35
        if ((0 === twig_compare(($context["breakpoint"] ?? null), ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["design"] ?? null), "layout", [], "any", false, true, false, 35), "stack_vertically", [], "any", true, true, false, 35)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["design"] ?? null), "layout", [], "any", false, true, false, 35), "stack_vertically", [], "any", false, false, false, 35), ($context["firstResponsiveBreakpointId"] ?? null))) : (($context["firstResponsiveBreakpointId"] ?? null)))))) {
            // line 36
            echo "%%SELECTOR%%.bde-columns {
...
";
        // line 51
        if ((0 === twig_compare(($context["breakpoint"] ?? null), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["design"] ?? null), "layout", [], "any", false, false, false, 51), "reverse_order", [], "any", false, false, false, 51)))) {
            // line 52
