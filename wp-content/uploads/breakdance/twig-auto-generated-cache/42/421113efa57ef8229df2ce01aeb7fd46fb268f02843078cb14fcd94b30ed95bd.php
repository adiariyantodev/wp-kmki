...
class __TwigTemplate_d82125f14c1860fa1608a6ae457808cb3ccc968a93f85188957fa9259b699cc3 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["design"] ?? null), "dividers", [], "any", false, false, false, 5), "shape_dividers_section", [], "any", false, false, false, 5), "dividers", [], "any", false, false, false, 5)) {
          ...
          ";
                // line 9
                if (((0 !== twig_compare(twig_get_attribute($this->env, $this->source, $context["divider"], "custom_shape", [], "any", false, false, false, 9), "")) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["divider"], "shape", [], "any", false, false, false, 9), "custom")))) {
                    // line 10
                    echo "            ";
