...
class __TwigTemplate_4f3fbb2fdd21f681debdfb105627e0e5b88e4e6ff71ce920e8468f496d679467 extends Template
{
    private $source;
    private $macros = [];
...
%%SELECTOR%% .advanced-slider__slide {
  ";
        // line 11
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["design"] ?? null), "container", [], "any", false, false, false, 11), "height", [], "any", false, false, false, 11), "viewport"))) {
            // line 12
            echo "   height: 100vh;
  ";
...
%%SELECTOR%% .advanced-slider__slide {
   ";
        // line 24
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["design"] ?? null), "container", [], "any", false, false, false, 24), "height", [], "any", false, false, false, 24), "viewport"))) {
            // line 25
            echo "   height: 100vh;
  ";
